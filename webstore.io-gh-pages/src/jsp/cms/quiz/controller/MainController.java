...
public class MainController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		if (request.getRequestURI().equals(applicationContextPath + "/")) {
			...
			System.out.println(request.getSession().getAttribute("xuser"));
			System.out.println(request.getSession().getAttribute("xmail"));
			System.out.println(request.getSession().getAttribute("xguest"));
		if ((request.getSession().getAttribute("xuser") == null) && (request.getSession().getAttribute("xmail") == null) &&  (request.getSession().getAttribute("xguest") == null)) {

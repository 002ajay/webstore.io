...
<div class="col-lg-3">
 ...
 <li role="presentation" class="active fadeInDown animated"><a href="home.jsp">Quiz</a></li>
  <li role="presentation" class="active fadeInDown animated"><a href="home.jsp">About Us</a><hr></li>
                        	...
                        	<input type="email" class="form-control" name="recipient" placeholder="Recipient address " required autofocus> 
                        	</div> <div class="form-group">
                        	<h4 >Subject </h4>
                        	<input type="text" class="form-control" name="subject" placeholder="Subject" required autofocus>
                        	</div> <div class="form-group">
                        	<h4>Content:</h4>
                        	<div class="form-group">
                        	<textarea rows="3" cols="71%" name="content"  required autofocus>
                        	</textarea></div>
                           <br/>
                        	<button type="submit" class="btn  btn-info btn-sm pull-left"> Send</button> </div></div> <br/><br/><br/>

...
<div class="col-lg-3">
 ...
 <li role="presentation" class="active fadeInDown animated"><a href="home.jsp">Quiz</a></li>
  <li role="presentation" class="active fadeInDown animated"><a href="home.jsp">About Us</a><hr></li>
	...
	<div class="col-lg-3">
<img src="iCO/add_contact.png" alt="add_contact">
	<a href="ManageStud.jsp"><h3 class="lead">STUDENT-DETAILS</h3></a>
	
	</div>
	
		<div class="col-lg-3">
	
	<img src="iCO/contact_approve.png" alt="contact_approve">
	<a href="ManageFaculty.jsp"><h3 class="lead">EMPLOYEE-DETAILS</h3></a>

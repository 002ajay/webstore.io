...
<nav>
	<ul class="pager XZ">
    <li class="previous"><a href="Data1.jsp"><span >&larr;</span> News</a></li>
     <li class="previous"><a href="News.jsp"><span >&larr;</span>Back</a></li>
  ...
  <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 100%;">
    <span class="sr-only"></span>
		  ...
		  <li role="presentation" class="fadeInDown animated"><a href="News.jsp">News-Events</a></li>
		  			 <%
						 session=request.getSession();
                   		String ss2x=(String) session.getAttribute("xmail");
					if(ss2x!=null){%>
...
for (int i = 0; i < 10; i++) {
id[i] = request.getParameter("checkx" + i);
}
%>
...
for (int a = 0; a < 10; a++) {
rs=st.executeQuery("select * from news where id='" + id[a]
+ "'");
        ...
        <div class="row ">
          ...
          <div class="panel panel-default ">
            <div class="panel-heading ">
              <h2 class="bounce animated">News</h2>
              </div><br/>
                <div class="panel-heading PII">
              <h4 class=" fadeInRight animated"> <h3>News Information</h3></h4>
              	<div class="form-group Nm">
              <label for="MyNm" class="fadeInLeft animated"> <h3>Posted On:</h3></label>
             <label class="lead fadeInRight animated"><h4><%=rs.getString("date") %></h4></label>
            </div>
            ...
            <div class="form-inline In">  <div class="well">
              <div class="form-group">
               ...
               <div class="col-lg-4"> 
  			<div class="form-group Nm">
              <label for="MyNm" class="fadeInLeft animated "> <h3>About:</h3></label>
             <label class="lead fadeInRight animated read-only"><%=rs.getString("disc") %></label>
            </div> <br/>

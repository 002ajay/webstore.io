...
<div class="alert alert-info" role="alert">Well done! Record Updated!</div>

<table class="table">
<tr> 
	 <td class="danger"> <h4> SId</h4> </td>
	 <td class="danger"> <h4> Session</h4> </td>
	 <td class="danger"> <h4> Admission</h4> </td>
	 <td class="danger"> <h4> Name</h4> </td>
	 <td class="danger"> <h4> Email</h4> </td>
	 <td class="danger"> <h4> Course</h4> </td>
	 <td class="danger"> <h4> Sem</h4> </td>
	 <td class="danger"> <h4> Gender</h4> </td>
	 <td class="danger"> <h4> FatherName</h4> </td>
	 <td class="danger"> <h4> Nation</h4> </td>
	 <td class="danger"> <h4> Religion</h4> </td>
	 <td class="danger"> <h4> Occuption</h4> </td>
	 ...
	 <td class="danger"> <h4> Address</h4> </td>
			...
			<td class="warning">  <%=rs.getString("session") %> </td>
			<td class="warning">  <%=rs.getString("exam") %> </td>
			<td class="warning">  <%=rs.getString("fname") %> </td>
			<td class="warning">  <%=rs.getString("email") %> </td>
			<td class="warning">  <%=rs.getString("course") %> </td>
			<td class="warning">  <%=rs.getString("sem") %> </td>
			<td class="warning">  <%=rs.getString("gender") %> </td>
			<td class="warning">  <%=rs.getString("ffname") %> </td>
			<td class="warning">  <%=rs.getString("nation") %> </td>
			<td class="warning">  <%=rs.getString("religion") %> </td>
			<td class="warning">  <%=rs.getString("foccu") %> </td>
			<td class="warning">  <%=rs.getString("fone") %> </td>
			<td class="warning">  <%=rs.getString("address") %> </td>

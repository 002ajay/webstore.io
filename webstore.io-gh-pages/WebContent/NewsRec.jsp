...
int i=ps.executeUpdate();
	if(i>0) {
		...
		request.getRequestDispatcher("NewsData.jsp").forward(request, response);
		
	} else {
		out.println("Fill all Fields");
		request.getRequestDispatcher("NewsFill.jsp").include(request, response);

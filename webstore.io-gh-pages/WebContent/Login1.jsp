...
<script> new WOW().init();</script>
	...
	background-image:url("iWall/Aerial_view_of_graphic_era_university - Copy.jpg");
       ...
       <div class="container"><br/><br/>
        ...
        <div class="container">
            <div class="row">
                ...
                <h2>Welcome. </h2>
                <p>
              Create Your Free <a href="Guest.jsp">CMS ID </a>  and Get Started Today ><br/>
        ...
        <div class="col-lg-4">
            <div class="list-group XLL">
                    <div class="account-wall">
                        <form class="form-group XL" method="post" action="Loginx.jsp">
                        	<input type="email" class="form-control" name="xmail" placeholder="email" required autofocus> <br/>
                            ...
                            <button class="btn btn-primary pull-right" type="submit"> Sign-in</button> <br/>

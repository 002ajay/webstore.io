...
<div class="alert alert-info " role="alert">Register User</div>
<br/>
		...
		<div class="container VV">
			...
			<div class="col-lg-12">
			  ...
			  <div class="col-lg-4 col-md-3">
			    <div class="thumbnail">
			      <img src="iWall/2013-08-26_09-42-56__Contacts_iOS7_App_Icon_Rounded.png" alt="2013-08-26_09-42-56__Contacts_iOS7_App_Icon_Rounded" class="img-thumbnail">
			    	 <div class="caption">
			      <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal1">
            Student Registration
			</button>
  <div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labeledby="myModalLabel" aria-hidden="true">
	  <div class="modal-dialog">
        ...
        <a href="SignUp.jsp"><button class="btn btn-info pull-right"> Insert</button> </a><br/>
			  ...
			  <div class="col-lg-4 col-md-3">
			    <div class="thumbnail">
			    <img src="iWall/user.png" alt="user" class="img-thumbnail">
		    	<div class="caption">
  ...
  <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  <div class="modal-dialog">
    	<div class="modal-content">
      		...
      		<div class="modal-body">
        <a href="UserProfileFill.jsp"><button class="btn btn-info pull-right" type="submit"> Insert</button> </a><br/>
    			</div>
    		</div>
  		</div>
	</div>

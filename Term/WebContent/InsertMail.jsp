...
String st=null;
        ...
        String nm=(request.getParameter("recipient"));
        String nm1=(request.getParameter("subject"));
        String nm2=(request.getParameter("content"));
...
try 
{
	...
	if(i>0) {
		...
		request.getRequestDispatcher("insertMail.jsp").include(request, response);

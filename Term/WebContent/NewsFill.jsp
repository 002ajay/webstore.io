...
<br/><br/><nav>
	<ul class="pager XZ">
    <li class="previous"><a href="Data1.jsp"><span >&larr;</span> Back</a></li>
...
<ul class="nav nav-pills nav-stacked" id="sidebar">
  ...
  <li role="presentation" class="active fadeInDown animated"><a href="Data1.jsp">DashBoard</a></li>
		  <li role="presentation" class="fadeInDown animated"><a href="News.jsp">News-Events</a></li>
   						<%
   						session=request.getSession();
                   		String sxs=(String) session.getAttribute("xmail");
						if(sxs!=null){
                     	%>
 ...
 <li role="presentation" class="active fadeInDown animated"><a href="home.jsp">Quiz</a></li>
  <li role="presentation" class="active fadeInDown animated"><a href="home.jsp">About Us</a><hr></li>
							...
							<div class="well">
							<div class=" ZX">
							<form action="MyFile1" method="post" enctype="multipart/form-data">
							<div class="form-group">
 							<h4 >S.N</h4>
                        	<input type="text" class="form-control" name="x" placeholder="S. Number" required autofocus> 
                        	</div> <div class="form-group">
                        	<h4 >Title </h4>
                        	<input type="text" class="form-control" name="xx" placeholder="Title Name" required autofocus>
                        	</div> 
                        	
                        	<div class="form-group">
                        	<h4 >Auther </h4>
                        	<input type="text" class="form-control" name="xxx" placeholder="Auther Name" required autofocus>
                        	</div> 
                        	<div class="form-group">
                        	<h4 >Date </h4>
                        	<input type="date" class="form-control" name="xxxx" placeholder="Date" required autofocus>
                        	</div><div class="form-group">
                        	<h4>Discription:</h4>
                        	<div class="form-group">
                        	<textarea rows="3" cols="72%" name="xxxxx"  required autofocus>
                        	</textarea></div>
                        	  <br/>
                        	  
                        	    <tr>
                             <td class="danger lead">Choose File : </td>
                             <td class="danger"><input type="file" name="photo" /></td>
                        </tr><br/>
                        <button type="submit" class="btn  btn-info btn-sm pull-right">Submit News</button> </form></div></div> <br/><br/><br/>

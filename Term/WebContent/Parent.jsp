...
<nav>
    ...
    <li class="previous"><a href="Manage.jsp"><span >&larr;</span> UserManage</a></li>
     <li class="previous"><a href="ManageStud.jsp"><span >&larr;</span>Manage Student</a></li>
...
for (int a = 0; a < 10; a++) {
rs=st.executeQuery("select * from stud2 where sid='" + id[a]
+ "'");
      ...
      <div class="container">
        <div class="row ">
          ...
          <div class="panel panel-default ">
              ...
              <h4 class="bounce animated">Parents Information</h4>
         ...
         <div class="col-lg-3">
            ...
            <div class="form-group Nm"><br/><br/>
              <label for="MyNm" class="fadeInLeft animated"> Father Name:</label>
               <label class="lead fadeInRight animated"><%=rs.getString("ffname") %></label>
               </div><br/>
		
            <div class="form-group Nm">
              <label for="MyNm" class="fadeInLeft animated"> Mother Name:</label>
             <label class="lead fadeInRight animated"><%=rs.getString("mname") %></label>
            </div> <br/>
		
            <div class="form-group Nm">
              <label for="MyNm" class="fadeInLeft animated">Father Occuption:</label>
               <label class="lead fadeInRight animated"><%=rs.getString("foccu") %></label></div> <br/>
            <div class="form-group Nm">
             <div class="form-group Nm">
              <label for="MyNm" class="fadeInLeft animated">Father Phone:</label>
               <label class="lead fadeInRight animated"><%=rs.getString("ffone") %></label></div> <br/>
               
               <div class="form-group Nm">
              <label for="MyNm" class="fadeInLeft animated">Father Email:</label>
               <label class="lead fadeInRight animated"><%=rs.getString("gmail") %></label></div> <br/>
            <div class="form-group Nm">
            
            <div class="form-group Nm">
              <label for="MyNm" class="fadeInLeft animated"> Mother Occuption:</label>
               <label class="lead fadeInRight animated"><%=rs.getString("moccu") %></label></div> <br/>

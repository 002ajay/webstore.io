...
try 
{
	...
	if(i>0) {
		request.getRequestDispatcher("Feed1.jsp").forward(request, response);
		
	} else {
		out.println("Fill all Fields");
		request.getRequestDispatcher("Data1.jsp").include(request, response);

...
<div class="col-lg-3 ">
  ...
  <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 100%;">
    <span class="sr-only"></span>
		  ...
		  <li role="presentation" class="active fadeInDown animated"><a href="Data1.jsp">DashBoard</a></li>
		    ...
		    <%
   						session=request.getSession();
		    String sxs=(String) session.getAttribute("xguest");
		    String sxs1=(String) session.getAttribute("xuser");
			if(sxs==null && sxs1==null){
                     	%>
 ...
 <li role="presentation" class="active fadeInDown animated"><a href="home.jsp">Quiz</a></li>
  <li role="presentation" class="active fadeInDown animated"><a href="About.jsp">About Us</a><hr></li>
		    ...
		    <%
   						session=request.getSession();
		    String sxzs=(String) session.getAttribute("xuser2");
			if(sxzs==null){
                     	%>
...
<tr>    <thead> 
        ...
        <form method="post" action="MyFile" enctype="multipart/form-data">
            <center>

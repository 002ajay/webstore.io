...
<script> new WOW().init();</script>
  ...
  body{
	...
	background-image:url("iWall/lol - Copy.jpg");
...
function fun(email,pass){ 
	var x=document.getElementById('xmail');
	var y=document.getElementById('xpass');
	if(8//8)
...
<body>
	...
	%>
        <div class="container"><br/><br/>
           ...
           <li class="divider"></li>
           <li class="active"> <a href="UserLogin1.jsp"> Faculty</a></li>
                      <li class="divider"></li>
           <li> <a href="GuestLoginForm.jsp"> Guest</a></li>
        ...
        <div class="container">
            ...
            <div class="list-group XLL">
                    <div class="account-wall">
                        <form class="form-group XL" method="post" action="Loginx1.jsp">
                        	<input type="email" class="form-control" name="xuser" placeholder="email" required autofocus> <br/>
                            <input type="password" class="form-control" name="xpass" placeholder="password" required> <br/>
                            <a href="User.jsp">Need an Account?</a> 
                            
                            <button class="btn btn-info pull-right" type="submit"> Sign-in</button> <br/>
               ...
               <div class="col-lg-7 HX">
                ...
                <h2>Welcome. </h2>
                <p>
               <strong>Faculty...!</strong>  Whats Up ?<br/>
                Please<em> Login </em>To Know More.......
                </p>
               </div>

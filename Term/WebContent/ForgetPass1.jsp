        ...
        <div class="container">
            ...
            <div class="list-group XLL">
                    <div class="account-wall">
                        <form class="form-group XL" method="post" action="ForgetPass2.jsp">
                          <input type="text" class="form-control" name="mail" placeholder="email" required autofocus> <br/>
                          
                              <label disabled="disabled">What is your fav Movie?</label>
                          
                            <input type="text" class="form-control" name="ans" placeholder="Answer" required> <br/>

                            <a href="SignUp.jsp">Need an Account?</a>                             
                            <button class="btn btn-info pull-right" type="submit"> Submit</button> <br/>
                          </form>
                    </div>
                </a> <br/>
                </a>
               ...
               <div class="col-lg-7 HX">
                ...
                <h2>Welcome. </h2>
                <p>Please Fill The Form to Recover Your<small>Password...!
               </small></p>
               </div>

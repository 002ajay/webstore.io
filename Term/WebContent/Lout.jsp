...
<script> new WOW().init();</script>
  ...
  <body>
  	<%
  	String user=(String) session.getAttribute("xuser");
  	String user1=(String) session.getAttribute("xguest");
  	...
  	%>
				...
				<div class="navbar navbar-inverse navbar-fixed-top">
					...
					<li> <a href="Course.jsp">Course</a></li>
					 ...
					 <%
						 session=request.getSession();
                   		...
                   		String ss3=(String) session.getAttribute("xguest");
                   ...
                   <%
						 session=request.getSession();
                   		String ss=(String) session.getAttribute("xuser");
						if(ss!=null){
                     %>
...
<div class="row"> 
		 ...
		 <div class="container CCCxx">
 <form action="LogoutGuest.jsp" method="post">
 <strong class="lead">Dear Guest? Are You Sure ? you Want To ?</strong>
 <button type="submit" class="btn btn-danger btn-lg" name="lg" id="lgx"  value="Logout" > Logout
 </button>
  <button type="submit" class="btn btn-default btn-lg" name="lgx1" id="lgx1"  value="Logout" >Close
 </button>
 </form>
 </div>
				<div class="Cvv">

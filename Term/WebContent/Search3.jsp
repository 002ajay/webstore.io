		...
		<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="navbar-collapse">
			...
			<div class="collapse navbar-collapse"> 
				<ul class="nav navbar-nav navbar-right"> 
					...
					<input type="text" class="form-control" placeholder="Search" name="search3">
					<button type="button" class="btn btn-default">Search<span class="glyphicon glyphicon-search" area-hidden="true"></span></button>
					</div>	
				     </form>
				 					</div>
								    </div>
...
<div class="alert alert-info" role="alert">Enter Class ID To Search Records. </div>

<table class="table table-bordered">
<tr> 
	 <td class="danger"> <h4> Class Id</h4> </td>
	 <td class="danger"> <h4> Class Name</h4> </td>
	 <td class="danger"> <h4> Fee</h4> </td>
	 <td class="danger"> <h4> Limits</h4> </td>
			<%
			if(rs.next()) {
			%>
		</tr>
			<td class="warning">  <%=rs.getString("cid") %> </td>
			<td class="warning">  <%=rs.getString("name") %> </td>
			<td class="warning">  <%=rs.getString("fee") %> </td>
			<td class="warning">  <%=rs.getString("limits") %> </td>

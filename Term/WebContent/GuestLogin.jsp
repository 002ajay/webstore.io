...
String st1=null;
String fn=null;
String xuser=request.getParameter("xuser1");
String xpass=request.getParameter("xuser2");
String mail=null;

try{
		Class.forName("com.mysql.jdbc.Driver");
		con1=DriverManager.getConnection("jdbc:mysql://localhost:3306/mystore","root","root");
		st1="select * from guest where mail =? and pass=?";
		...
		if(rs1.next()) 
		{
			...
			session.setAttribute("xguest",rs1.getString(2));
			...
			rd.forward(request, response);
				...
				RequestDispatcher rd= request.getRequestDispatcher("GuestLoginForm.jsp");

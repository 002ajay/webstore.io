...
<div class="progress">
 ...
 <li role="presentation" class="active fadeInDown animated"><a href="home.jsp">Quiz</a></li>
  <li role="presentation" class="active fadeInDown animated"><a href="About.jsp">About Us</a><hr></li>
  		 ...
  		 <form class="form-group" method="post" action="DepartmentInsert.jsp">
                     	<input type="text" class="form-control" name="id" placeholder="Enter Department ID" required autofocus> <br/>
                      	<input type="text" class="form-control" name="name" placeholder="Enter Department Name" required> <br/>
                   	  <button type="submit"class="btn btn-info pull-right" > Submit</button> <br/>
					  </form></div></div>

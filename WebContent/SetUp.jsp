...
<nav>
	<ul class="pager XZ">
    <li class="previous active"><a href="Data1.jsp"><span >&larr;</span> Setting</a></li>
...
<div class="ZX"><br/><br/>
	...
	<hr>
		<div class="col-lg-3 CCCC ">
	
	<a href="Forgot1.jsp"><img src="iCO/key.png" alt="settings" class="pulse animated img-thumbnail">
	<h3 class="lead flash animated">Change Password</h3></a><hr>
	
	</div>
	
	<div class="col-lg-3">
	<a href="Owner1.jsp">
	<img src="iCO/edit.png" alt="bar_chart" class="fadeInLeft animated img-thumbnail">
	<h3 class="lead flash animated"">Edit Profile</h3></a><hr>
	
	</div>
	
		<div class="col-lg-3">
	<a href="Logout.jsp">
	<img src="iCO/warning_sign.png" alt="notebook" class="pulse animated  img-thumbnail">
	<h3 class="lead flash animated"">LogOut</h3></a><hr>

...
<div class="col-lg-3">
  ...
  <li role="presentation" class="fadeInDown animated"><a href="Msg2.jsp">Manage Messages</a></li>
...
<br/><br/>
<div class="alert alert-info fadeInRight animated" role="alert">MESSAGEs </div>
<table class="table fadeInUp animated">
<tr> 
	 <td class="info bounce animated"> <h4> First Name</h4> </td>
	   <td class="info bounce animated"> <h4> Email</h4> </td>
	     <td class="info bounce animated "> <h4> Messages</h4> </td>
	      <td class="info bounce animated "> <h4> Reply</h4> </td>
	     <td class="info bounce animated"> <h4> Action</h4> </td>
			...
			<td class="warning">  <%=rs.getString("fname") %> </td>
			<td class="warning">  <%=rs.getString("mail") %> </td>
			<td class="warning">  <%=rs.getString("msg") %> </td>
			
			<form name=myname class="FM flash animated" method=post action="ReplyGuest.jsp">
			<td class="warning">
			<input type="hidden" name="rep" value="Reply">
			<a herf="#"><input type="submit" value="Reply" class="btn btn-custom CX pull-right"></a></td> 
			</form>
			
			
			<form name=myname class="FM flash animated" method=post action="MsgDel.jsp">
			<td class="warning"><input type="hidden" name="check<%=iii%>"
			value=<%=rs.getString(1)%>>
			<a herf="#"><input type="submit" value="delete" class="btn btn-custom CX pull-right"></a></td> 
			</form>
			</tr>
			<%
	}

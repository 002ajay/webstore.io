...
<div class="alert alert-info" role="alert">Manage User</div>
<br/>
<div class="jumbotron JT">
		<div class="container VV">
			...
			<div class="col-lg-12">
			  ...
			  <form action="ManageFaculty.jsp" method="Post">
			    <div class="thumbnail">
			    <img src="iWall/4.png" alt="Users" class="img-thumbnail img-responsive">
		    	<div class="caption XC">
			...
			<div class="col-lg-6 col-md-3 ">
			  <form action="ManageStud.jsp" method="Post">
			    <div class="thumbnail">
			      <img src="iWall/3.png" alt="user" class="img-thumbnail">
			    	 <div class="caption XC">
			      <button type="submit" class="btn btn-primary btn-sm " >
            Student Manage
			</button></form>

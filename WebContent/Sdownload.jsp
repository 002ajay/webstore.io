...
<%@page import="java.util.List"%>     <%@ page import= "java.io.*" %>
...
</div><li role="presentation" class="active fadeInDown animated"><a href="News.jsp">News-Events</a></li>
...
<div class="alert alert-info fadeInDown animated"" role="alert">Syllabus Details</div>

        
       <table class="table table-responsive bounce animated">
            <thead> 
               <th colspan="3"><div class="well fadeInRight animated">Uploaded Files</div></th>        
            </thead>
                <tbody>
                    <tr>
                         <td class="danger"><center><b>Department</b></center>
                          <td class="danger"><center><b>Course</b></center>
                          <td class="danger"><center><b>Semester</b></center>
                    ...
                    <%
                        try
                        {
                            ...
                            %>
                                    <tr>
                                    <td class="success"><center><%out.print(rs1.getString("department")); %></center></td>
                                    <td class="success"><center><%out.print(rs1.getString("course")); %></center></td>
                                    <td class="success"><center><%out.print(rs1.getString("sem")); %></center></td>
                                    <td class="success"><center><a href="view_file.jsp?id=<%out.print(rs1.getString("id"));%>">View</a></center></td>
                                <!--<td class="success"><center><a href="DBFileDownloadServlet?id=<%out.print(rs1.getString("id"));%>">Download</a></center></td> -->
 					...
 					<td class="info"><input type="checkbox" name="check1<%=iii%>"
						...
						<input type="submit" value="Delete" class="btn btn-danger fadeInleft animated"></td></form></tr>
                            <%
                                }
                                }
                            %>

...
<div class="col-lg-3">
  ...
  <li role="presentation" class=" fadeInDown animated"><a href="FeedDel.jsp">Manage Feedback</a></li>
...
<tr> 
	 <td class="info bounce animated"> <h4> First Name</h4> </td>
	  <td class="info bounce animated"> <h4> Last Name</h4> </td>
	   <td class="info bounce animated"> <h4> Email</h4> </td>
	    <td class="info bounce animated"> <h4> Phone</h4> </td>
	     ...
	     <td class="info bounce animated"> <h4> Action</h4> </td>
			...
			<td class="warning">  <%=rs.getString("lname") %> </td>
			<td class="warning">  <%=rs.getString("email") %> </td>
			<td class="warning">  <%=rs.getString("fone") %> </td>
			<td class="warning">  <%=rs.getString("msg") %> </td>
			
			<form name=myname class="FM flash animated" method=post action="FeedDelx.jsp">

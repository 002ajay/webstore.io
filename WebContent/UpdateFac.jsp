...
<nav>
	<ul class="pager XZ">
    <li class="previous"><a href="ManageFaculty.jsp"><span >&larr;</span> Back</a></li>
...
for (int a = 0; a < 10; a++) {
rs5=st5.executeQuery("select * from profile where profileid='" + id[a]+ "'");
...
%>
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              ...
              <h4>Update Profile.. <%=rs5.getString("firstname") %> <%=rs5.getString("lastname") %> </h4>
              </div>
              <div class="panel-body">
                      <form method="post" action="Sign3.jsp" role="form">
            <div class="form-inline In">
              ...
              <div class="form-group"><fieldset disabled>
                ...
                <input type="text" class="form-control SS" id="MyId" name="nm1" value="<%=rs5.getString("firstname") %>">
             </fieldset> </div> 
               <div class="form-group"> <fieldset disabled><label for="gen"  class="mt">Gender:</label>
            ...
            <br/></div> 
             <div class="form-group"> <fieldset disabled>
              <label for="nm">Last Name :</label>
                <input type="text" class="form-control SS" id="MyId" name="nm2" value="<%=rs5.getString("lastname") %>" required autofocus> </fieldset> 
            </div>
             <div class="form-group">
              <label for="ms" class="mt1">Marital Status:</label>
              <select class="form-control SS3"  name="nm3">
                <option value="<%=rs5.getString("maritalstatus") %>"> Single</option>
                <option value="<%=rs5.getString("maritalstatus") %>"> Married</option>
              </select>
            </div><br/> 
            <div class="form-group "> <fieldset disabled>
              <label for="nm">Father Name :</label>
                <input type="text" class="form-control S00S" id="MyId" name="nm02" value="<%=rs5.getString("fathername") %>" required autofocus> </fieldset> 
            </div>
                <div class="form-group  S00S1"><fieldset disabled>
                <label for="dob"> DOB :</label>
                <input type="date" class="form-control SS" id="MySs" name="nm4"  value="<%=rs5.getString("dob") %>"required autofocus> </fieldset> 
              </div><br/>
             </div>
            </div> <br/> <br/>
          ...
          <strong ><h4>Contact Information</h4></strong> 
              ...
              <label for="nm">Email :</label> 
                <input type="email" class="form-control SS" id="MyId" name="nm5"  value="<%=rs5.getString("mail") %>" required autofocus>
             </div>

             <div class="form-group">
              <label for="nm" class="mt4">Street:</label>
                <input type="text" class="form-control SSg" id="MyId" name="nm6"  value="<%=rs5.getString("streeet") %>" required autofocus>
             </div><br/>

             <div class="form-group">
              <label for="nm">Address:</label>
                <input type="text" class="form-control SSe" id="MyId" name="nm7"  value="<%=rs5.getString("localaddress") %>" required autofocus>
             </div> 

             <div class="form-group">
              <label for="nm" class="mt2">Pin:</label>
                <input type="text" class="form-control SSf" id="MyId" name="nm8"  value="<%=rs5.getString("pin") %>"required autofocus>
             </div>

             <div class="form-group">
              <label for="nm">City:</label>
                <input type="text" class="form-control SSh" id="MyId" name="nm9" value="<%=rs5.getString("city") %>" required autofocus>
             </div>

               <div class="form-group">
              <label for="nm" class="mt3">State:</label>
                <input type="text" class="form-control SS" id="MyId" name="nm10"  value="<%=rs5.getString("state") %>" required autofocus>
             </div></div></div> <br/> <br/>
              ...
              <label for="nm">Qualification:</label>
                <input type="text" class="form-control SS" id="MyId" name="nm11"  value="<%=rs5.getString("qualification") %>" required autofocus>
             </div>

             <div class="form-group">
              <label for="nm"class="mt6">Experience:</label>
                <input type="text" class="form-control SSm" id="MyId" name="nm12"  value="<%=rs5.getString("experience") %>" required autofocus>
             </div><br/>

             <div class="form-group">
              <label for="nm">Language Speak:</label>
                <select class="form-control SSj"  name="nm13">
                <option  value="<%=rs5.getString("languageknown") %>"> Hindi</option>
                <option value="<%=rs5.getString("languageknown") %>"> English</option>
              </select>
             </div> 


             <div class="form-group">
              <label for="nm">Date Of Joining:</label>
                <input type="date" class="form-control SSk" id="MyId" name="nm15" value="<%=rs5.getString("dateofjoining") %>" required autofocus>
             </div>

               <div class="form-group">
              <label for="nm"class="mt6">Date Of Leaving:</label>
                <input type="date" class="form-control SSm2" id="MyId" name="nm16" value="<%=rs5.getString("dateofleaving") %>"required autofocus>
             </div>

              <div class="form-group"><fieldset disabled>
              <label for="nm">Department: </label>
                <input type="text" class="form-control SSl" id="MyId" name="nm17" value="<%=rs5.getString("departmentid") %>" required autofocus></fieldset>
             </div>

             <div class="form-group">
              <label for="nm"class="mt6">Research Area: </label>
                <input type="text" class="form-control SSm1" id="MyId" name="nm18" value="<%=rs5.getString("researcharea") %>">
             </div>

             <div class="form-group">
              <label for="nm">Specialization: </label>
                <input type="text" class="form-control SSm3" id="MyId" name="nm19" value="<%=rs5.getString("specialization") %>">
             </div>
           </div></div> <br/> <br/>
          ...
          <strong ><h4>Other Information</h4></strong> 
              ...
              <label for="nm">  Blood-Group:</label>
               <select class="form-control SS3"  name="nm20">
                <option value="<%=rs5.getString("bloodgroup") %>">A</option>
                 <option  value="<%=rs5.getString("bloodgroup") %>">B</option>
                  <option  value="<%=rs5.getString("bloodgroup") %>">A+</option>
                   <option value="<%=rs5.getString("bloodgroup") %>">AB</option>
                    <option  value="<%=rs5.getString("bloodgroup") %>">O+</option>
              </select></fieldset>
             </div>
             ...
             <div class="form-group"> <fieldset disabled>
              <label for="nm22">Nationality:</label>
                 ...
                 <option value="<%=rs5.getString("nationality") %>">Indian</option>
                <option value="<%=rs5.getString("nationality") %>"> Ausis</option>
              </select></fieldset>
             </div> 

             <div class="form-group">
              <label for="nm23" class="mtx1zc">Post:</label>
                <input type="text" class="form-control SSv" id="MyId" name="nm23" value="<%=rs5.getString("post") %>" required autofocus>
             </div><br/>
             
              <div class="form-group"> 
              <label for="nm23" class="mtx1z">Profile ID:</label>
                <input type="text" class="form-control SSv" id="MyId" name="nm24" value="<%=rs5.getString("profileid") %>"readonly  required autofocus>
             </div>
             
             
              <div class="form-group"> <fieldset disabled>
              <label for="nm23" class="mtx1zc1">User ID:</label>
                <input type="text" class="form-control SSv1x" id="MyId" name="nm25" value="<%=rs5.getString("userid") %>" required autofocus></fieldset>
             </div>
         ...
         <div class="form-group"> <fieldset disabled>
          ...
          <br/><br/>
            <button type="submit" class="btn btn-primary btn-lg BTNX"> Submit</button></form>
        </div></div> </div></div> </div></div> </div></div> </div></div></div></div></div><br/><br/><br/>

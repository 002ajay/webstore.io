...
<table class="table table-hover table-bordered">
			...
			<div class="Well"><td class="warning"> <strong>Procedure:</strong><br/><hr><h5><c:out value="${allcourses.elig}" /> </h5></td><br/></div>
		   <div class="Well"><td class="warning"><strong>CourseType:</strong><br/><hr><h5><c:out value="${allcourses.type}" /></h5></td><br/></div>
	       <div class="Well"> <td class="warning"><strong> Eligibility:</strong><br/><hr><h5><c:out value="${allcourses.pro}" /></h5></td><br/></div>
</tr>
         </c:forEach>
        </table>
    </div>

...
for (int a = 0; a < 10; a++) {
st.executeUpdate("delete from stud2 where sid='" + id[a]
+ "'");
if(id[a] != null){%>
<div class="col-lg-12">

<button class="btn btn-primary btn-block CV"  type="button">
 <h4>Student ID : <span class="badge"><strong><%= id[a]%></strong>  </span>Deleted Successfully </h4>
</button>
...
<a href="ManageStud.jsp">Click here to go to Home</a>

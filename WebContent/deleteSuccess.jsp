...
for (int i = 0; i < 10; i++) {
id[i] = request.getParameter("check1" + i);
}
%>
<body bgcolor="beige">
<%
...
for (int a = 0; a < 10; a++) {
st.executeUpdate("delete from profile where profileid='" + id[a]
+ "'");
if(id[a] != null){%>
<div class="col-lg-12">

<button class="btn btn-primary btn-block CV"  type="button">
 <h4>Employee ID : <span class="badge"><strong><%= id[a]%></strong>  </span>Deleted Successfully </h4>
</button>
...
<a href="ManageFaculty.jsp">Click here to go to Home</a>

      ...
      <div class="col-lg-4 HX">
            ...
            <div class="list-group XLL">
                    <div class="account-wall">       
                        <form class="form-group XL" method="post" action="StudForget2.jsp">
                            <input type="password" class="form-control" name="pass1" placeholder="Enter Old Password" required> <br/>
                             <input type="password" class="form-control" name="pass2" placeholder="Enter New Password" required> <br/>
                              <input type="password" class="form-control" name="pass3" placeholder="Enter Confirm Password" required> <br/>
